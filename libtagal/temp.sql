...
select distinct t.id, t.tag from tags as t, tag_file_map as map, files as f where t.id = map.tid and f.id = map.tid and f.path='/home/monnand/data/doc/p2p/BitTorrent/bittorrentecon.pdf';
